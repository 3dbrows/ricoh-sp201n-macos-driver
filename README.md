...
This project would not have been possible without the prior reverse-engineering and driver work done for these Ricoh GDI printers on Linux. The original `pstoricohddst-gdi` shell script and PPD which you may find elsewhere served as inspiration for this driver, and I extend my thanks to the various contributors thereto.
